  ...
  var Window = function(options) {
    ...
    if (options.events) {
      for (var eventName in options.events) {
        if (
          options.events.hasOwnProperty(eventName) &&
    ...
    this.widget = false;
    this.movable =
      typeof options.movable !== 'undefined' ? options.movable : true;
    this.resizable =
      typeof options.resizable !== 'undefined' ? options.resizable : true;
    this.animations =
      typeof options.animations !== 'undefined' ? options.animations : true;
    this.titlebar = true;
    this.stayinspace =
      typeof options.stayinspace !== 'undefined' ? options.stayinspace : false;
  };
        ...
        mousemove: function(e) {
          ...
          if (this._moving) {
            if (this.stayinspace) {
              ...
              var minusY = 0;
              if (
                movingX + this.el[0].clientWidth >
                this.space[0].clientWidth
              ) {
                minusX =
                  movingX + this.el[0].clientWidth - this.space[0].clientWidth;
              }
              if (
                movingY + this.el[0].clientHeight >
